...
TableTools.prototype = {
	...
	"_fnButtonBase": function ( o, bCollectionButton )
	{
		...
		var
		  ...
		  admin = this._fnGetadminettings();

		nButton.className = sClass+" "+o.sButtonClass;
		nButton.setAttribute('id', "ToolTables_"+this.s.dt.sInstance+"_"+admin.buttonCounter );
	 ...
	 *  @method  _fnGetadminettings
	 *  @returns {Object} TableTools settings object
	 *  @private 
	 */
	"_fnGetadminettings": function ()
	{
		if ( this.s.master )
		{
			return this.s;
 ...
 *  @static
 */
TableTools.fnGetadmin = function ()
{
	var a = [];
